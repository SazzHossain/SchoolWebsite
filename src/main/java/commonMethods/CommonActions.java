...
public class CommonActions {
	...
	//common method for element.click()
	...
	//common method for element.clear()
	public static void clearElement(WebElement element) {	
		try {
			element.clear();
			Loggers.logTheTest(element + "-------> has been cleared");
		} catch (NoSuchElementException | NullPointerException e) {
			Loggers.logTheTest(element + "-------> couldn't clear\n" + e.getMessage());
		}
	}
	
	//common method for element.sendKeys(text)
	public static void inputText(WebElement element, String text) {	
		try {
			element.sendKeys(text);
			Loggers.logTheTest(element + "-------> send the text");
		} catch (NoSuchElementException | NullPointerException e) {
			Loggers.logTheTest(element + "-------> couldn't write the text\n" + e.getMessage());
		}		
	}
	
	//common method for Thread.sleep(ms)
		public static void pause(long miliSec) {	
			try {
				Thread.sleep(miliSec);
				Loggers.logTheTest("Sleeping ...zZz " + miliSec);
			} catch (InterruptedException | NoSuchElementException | NullPointerException e) {
				Loggers.logTheTest( "Sleep interrupted because of....." + e.getMessage());
			}
		}
		
		//common method for element.isDisplayed()
		...
		//common method for element.isEnabled()
		...
		//common method for element.isSelected()
		...
		//common method for driver.getTitle()
		...
		//common method for driver.getCurrentUrl();
		...
		//common method for element.getText()
...
//		}
		...
		// This is build ONLY for Enthrall IT website
